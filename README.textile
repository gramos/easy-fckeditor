...
ramos.gaston [at] gmail [dot] com
  ...
  [http://gastonramos.wordpress.com/](http://gastonramos.wordpress.com/)

**Easy FCKEditor is a Rails Plugin thats generate a WYSIWYG text editor helper**. This version is a fork of Scott Rutherford great plugin [1] with a EasyUpload plugin [2] inlcuded of Alfonso Martínez de Lizarrondo.

This plugin installs the FCKeditor editor into your rails app, along with some helpers to use in your views.

1 [http://blog.caronsoftware.com/2007/11/16/fckeditor-plugin-0-4-2-released](http://blog.caronsoftware.com/2007/11/16/fckeditor-plugin-0-4-2-released)

2 [http://martinezdelizarrondo.com/easyupload/](http://martinezdelizarrondo.com/easyupload/)
